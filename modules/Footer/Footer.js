...
export class Footer {
    ...
    getHtml() {
        ...
        <div class="footer__contacts contacts">
            ...
            <ul class="contacts__list">
                <li class="contacts__item">
                    <a class="contacts__link contacts__link_vk" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                ...
                <li class="contacts__item">
                    <a class="contacts__link contacts__link_youtube" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                ...
                <li class="contacts__item">
                    <a class="contacts__link contacts__link_tg" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
        ...
        <ul class="footer__developer-list">
            ...
            <li class="footer__developer-item">
                Developer:
                <a class="footer__developer-link" href="https://t.me/LeerenaDev" target="_blank">Elena Shipilevskaya</a>
            </li>
        </ul>
